...
class LocationPopupMenu(ListMDDialog):
    def __init__(self, spot_data):
        ...
        headers = ['ids', 'SpotName', 'x', 'y', 'MapsLink', 'Website', 'Street', 'City', 'Country', 'PLZ', 'Season1Date', 'Season1Time', 'Season2Date', 'Season2Time', 'Image1', 'Image2', 'Image3', 'Information', 'updateTime']
        ...
        try:
            ...
            file = open(f"image1{self.SpotName}{self.ids}.png", "wb")
        ...
        try:
            ...
            file = open(f"image2{self.SpotName}{self.ids}.png", "wb")
            file.write(response.content)
            file.close()
        except:
            response = requests.get("https://raw.githubusercontent.com/infinitel8p/Topspot/master/Images/missing.jpg", verify=certifi.where())
        ...
        try:
            ...
            file = open(f"image3{self.SpotName}{self.ids}.png", "wb")
            file.write(response.content)
            file.close()
        except:
            response = requests.get("https://raw.githubusercontent.com/infinitel8p/Topspot/master/Images/missing.jpg", verify=certifi.where())
